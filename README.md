## To get the project running, firstly you will need to create a database with name 'netpay' then, supply the database config (name and password) on for you local config on config.php.
